...
string Cuento = $"En el vasto universo digital existía un pequeño programa llamado Bitín. " +
    $"\r\nBitín explorador recorría mundos binarios formados por ceros y unos. " +
    $"\r\nSu meta era encontrar las ciudades luminosas ocultas tras el firewall.  " +
    $"\r\n" +
    $"\r\nEn su viaje conoció a la Nube, que le mostró secretos del gran mundo conectado.  " +
    $"\r\nLa Nube le habló de un protagonista misterioso que buscaba una meta aún mayor.  " +
    $"\r\nBitín escuchó con atención y supo que debía seguir adelante.  " +
    $"\r\n" +
    $"\r\nEl camino estaba lleno de obstáculos, pero Bitín tenía un propósito claro.  " +
    $"\r\nCada cero y cada uno le recordaban que todo sistema puede transformarse.  " +
    $"\r\nCon valentía, el programa avanzó entre códigos y protocolos.  " +
    $"\r\n\r\nAl final, cuando parecía que todo estaba perdido,  " +
    $"\r\nBitín descubrió que incluso en los ceros y unos podía encontrar esperanza.  " +
    $"\r\nY así, el explorador siguió su viaje hacia un futuro lleno de posibilidades."; 
...
string Uso_TTrim = "     En su viaje conoció a la Nube, que le mostró secretos del gran mundo conectado.     ".Trim();
Console.WriteLine("\nReto 17: Eliminar espacios: " + Uso_TTrim);
