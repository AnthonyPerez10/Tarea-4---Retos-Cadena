...
try
{
    //Añadiendo para que los resultados de los retos se guarden en un txt
    StreamWriter escribir = new StreamWriter("resultado.txt");

    //Direccion de acceso al cuento.txt
    Cuento = File.ReadAllText(@"C:\Users\FLIA PEREZ\Desktop\U.T.P\4° SEMESTRE 2025\DES. SOFT. IV\cuento.txt");
    //Console.WriteLine(Cuento);

    escribir.WriteLine("Retos de Cadenas en C# \n"); //Titulo principal
    ...
    escribir.WriteLine("Reto 1: " + Conc_nombre_pal);
    ...
    escribir.WriteLine(Interpolacion);
    ...
    escribir.WriteLine("El carácter en esa posición es: " + caracterEnPosicion);
    ...
    escribir.WriteLine("\nReto 12: Quitar los primeros caracteres: \n" + delete);
    ...
    escribir.Close(); //Cerrar la acumulacion de resultados en .txt

    Console.WriteLine("Resultados capturados correctamente"); 
